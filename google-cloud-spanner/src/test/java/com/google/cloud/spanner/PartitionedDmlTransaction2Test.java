...
public class PartitionedDmlTransaction2Test {
  ...
  private PartitionedDmlTransaction2 tx;
  ...
  public void setup() {
    ...
    PartitionedDmlTransactionRequestFactory requestFactory = new PartitionedDmlTransactionRequestFactory(session, rpc);
    tx = new PartitionedDmlTransaction2(session, rpc, ticker, requestFactory);
  }
